...
export default class SearchDietician extends PureComponent {
    constructor(props) {
        super(props);
        ...
        return (
            <ScrollView style={{ flex: 1, backgroundColor: '#eeeeee' }}>
                <View style={style.container}>
                    ...
                    <Text style={{ marginLeft: 0, fontFamily: 'ProductSans-Regular', fontSize: 18, color: '#202020',marginLeft:25 ,marginTop:20}}>20 Dietician found</Text>
                    <View style={{ flex: 1, alignItems: 'center',justifyContent:'center'}}>
                            <View style={{ width: '95%',alignItems: 'center',justifyContent:'center',marginBottom:20 }}>
                           
                            <FlatList
                                    data={[{key: 'Rahul Joshi'}, {key: 'Suresh Jain'}]}
                                    renderItem={({item}) => 
                                    <Card style={{ marginTop: 20, height: 100, width: width-30, borderRadius: 10,flexDirection:'row' }}>
                                    <View style={{width:'30%',height:'100%',justifyContent:'center',alignItems:'center'}}>
                                    <Image source={user} style={{width:80,height:80}}/>
                                
                                     </View>
                                     <View style={{width:'50%',height:'100%',justifyContent:'center',alignItems:'flex-start'}}>
                                     <Text style={{ marginLeft: 0, fontFamily: 'ProductSans-Regular', fontSize: 16, color: '#202020',marginLeft:5 }}>{item.key}</Text>
                                     <Text style={{ marginLeft: 0, fontFamily: 'ProductSans-Regular', fontSize: 16, color: '#808080',marginLeft:5 }}>Yoga Trainer</Text>
                                    
                                    
                                     </View>
                                     <TouchableOpacity onPress={()=>Actions.push('SearchFood')} style={{width:'20%',height:'100%',alignItems:'center',justifyContent:'center'}}>
                                     <Icon name="ios-arrow-forward" style={{fontSize:25,color:'#DE1826'}} />
                                     </TouchableOpacity>
